...
function generarRespuestaFallback(mensaje, departamento) {
  ...
  if (m.includes('antibiótico') || m.includes('antibiotico') || m.includes('zona norte') || m.includes('quiebre')) {
    return 'SANFER detecta quiebre inminente en Antibióticos Zona Norte: demanda +34.7% vs stock actual. Se requiere acción inmediata. ¿Genero la orden de reabastecimiento prioritaria?';
  }
  ...
  if (m.includes('inventario') || m.includes('stock') || m.includes('surtido') || m.includes('abastec') || m.includes('sanfer')) {
    return 'SANFER monitorea 24,390 SKUs con 94.3% precisión IA. Hay 3 alertas de stock activas y riesgo desabasto del 7.4% nacional. ¿Revisamos las zonas críticas?';
  }
...
SANFER-IQ — Inteligencia de Demanda y Abastecimiento
...
SANFER-IQ — Inteligencia Epidemiológica
...
SANFER-IQ: Quiebre inminente Antibióticos Zona Norte — stock vs demanda +34.7% — CRÍTICO (hace 2h)

SANFER-IQ: Epidemiológico — Influenza A +18.6% en 8 zonas, COVID-19 +12.3% en 6 zonas, CDMX riesgo 92 (hace 15 min)

Dashboard: 38 alertas activas, 7.4% riesgo desabasto, 156 SKUs críticos (hace 30 min)

SANFER-IQ: Reabastecimiento completado CDMX, cobertura 92.6% (hace 4h)

SANFER-IQ: Sobrestock Vitaminas Occidente -3.2%, cluster Alérgica riesgo bajo (hace 6h)
...
SANFER-IQ Demanda y Abastecimiento — ya activo, 94.3% precisión

SANFER-IQ Epidemiológico — ya activo, 96.1% precisión
...
Si pregunta por SANFER-IQ / abastecimiento / demanda:
