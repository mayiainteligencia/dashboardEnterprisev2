...
import { Toasts, useAlertas } from './components/Toasts';
...
function App() {
  ...
  return (
    <ResponsiveLayout
      ...
      header={<Header title={getTitulo()} notificaciones={alertas} setNotificaciones={setAlertas} />}
      sidebar={
        <Sidebar
          activeSection={activeSection}
          onSectionChange={setActiveSection}
