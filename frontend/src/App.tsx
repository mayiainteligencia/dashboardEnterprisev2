...
function App() {
  ...
  const getTitulo = () => {
    const titulos: Record<string, string> = {
      ...
      operaciones: 'Producción y Operaciones',
      ventas: 'Ventas y Distribución',
      ti: 'Tecnologías de la Información',
      administracion: 'Administración',
      comercial: 'Centro Comercial VitroForte',
      leads: 'Prospectos',
      operacion: 'Producción · Inventario y Logística',
      influencers: 'Radar de Mercado',
      ceo: 'Vista CEO',
      scoring: 'Lead Scoring IA',
      campanias: 'Campañas',
      vendedores: 'Asesores Comerciales',
      inventario: 'Inventario de Blindaje',
