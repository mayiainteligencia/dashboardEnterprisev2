  ...
  const alertas: Alerta[] = [
    {
      id: '1',
      tipo: 'critico',
      titulo: 'Mal comentario en redes sociales',
      mensaje: 'Se detectaron comentarios negativos en la última publicación',
      tiempo: 'Hace 5 min',
      departamento: 'Redes sociales',
    },
    {
      id: '2',
      tipo: 'advertencia',
      titulo: 'Desabasto de modelo 34-12aw',
      mensaje: 'Se requiere atención en la sucursal 2',
      tiempo: 'Hace 1 hora',
    ...
    },
    {
      ...
      mensaje: 'Encender intervención humana',
      tiempo: 'Hace 2 horas',
      departamento: 'RH',
    },
    {
