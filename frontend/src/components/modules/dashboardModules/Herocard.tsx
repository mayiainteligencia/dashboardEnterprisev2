...
import { BrianCanvas } from './BrianCanvas';
...
export const HeroCard: React.FC = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      role: 'assistant',
      content: `¡Hola! Bienvenido a VitroForte, tu sistema de gestión de vidrios blindados. ¿En qué podemos ayudarte?`,
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 10, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <div style={{ width: '240px', marginBottom: '8px' }}>
            <BrianCanvas accent={colores.primario} height={200} />
          </div>
          ...
          >
            Asistente Inteligente · VitroForte
          </h2>
          ...
          >
            Pulsa para hablar con tu asesor IA · di <strong style={{ color: colores.primario, fontStyle: 'normal' }}>"MAYIA"</strong> para enviar
          </p>
        </div>
