...
// ───────────────────────────────────────────────────────────────────────────────
// 1 · Vista CEO — KPIs globales + mini-ranking, click → tabla y barras de 13 agencias
export const VistaCEO: React.FC = () => {
  ...
  return (
    <Card icon={Crown} title="Vista CEO" subtitle="13 agencias · consolidado" badge={<Pill text="EN VIVO" color={colores.exito} />} cta="Ver tablero ejecutivo" detalle={detalle}>
...
// 2 · Lead Scoring IA — anillos + distribución, click → factores por prospecto
export const LeadScoring: React.FC = () => {
  ...
  return (
    <Card icon={Target} title="Lead Scoring IA" subtitle="Intención de compra" badge={<Pill text="IA" />} cta="Ver factores de scoring" detalle={detalle}>
...
// 3 · Campañas — ROI bars, click → desglose y atribución
export const Campanias: React.FC = () => {
  ...
  return (
    <Card icon={Megaphone} title="Campañas" subtitle="Inversión, ROI y atribución" cta="Ver desglose completo" detalle={detalle}>
...
// 4 · Vendedores — ranking + eficiencia, click → tabla y eficiencia por etapa
export const Vendedores: React.FC = () => {
  ...
  return (
    <Card icon={Users} title="Vendedores" subtitle="Ranking y eficiencia" cta="Ver eficiencia por etapa" detalle={detalle}>
      <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', overflowY: 'auto', minHeight: 0 }}>
        {vendedores.map((v, i) => (
...
// 5 · Inventario inteligente — días en lote + demanda, click → tabla y rotación
export const InventarioInteligente: React.FC = () => {
  ...
  return (
    <Card icon={Package} title="Inventario Inteligente" subtitle="Stock · días en lote · demanda" cta="Ver rotación y alertas" detalle={detalle}>
      <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', overflowY: 'auto', minHeight: 0 }}>
        {inventario.map(it => {
...
// 6 · Conversión y Retención (módulo especial combinado)
export const ConversionRetencion: React.FC = () => {
  ...
  return (
    <Card icon={Repeat} title="Conversión y Retención" subtitle="Embudo IA + recompra" badge={<Pill text="ESPECIAL" color={colores.primario} />} cta="Ver embudo y cohortes" detalle={detalle}>
